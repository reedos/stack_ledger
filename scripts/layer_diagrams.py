...
def render_layer_diagram(layer,sources,color='#c5f277'):
    ...
    markers=''.join(f'<marker id="arrow-{layer}-{k}" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0 8 4 0 8Z" fill="{color}"/></marker>' for k,color in [('power','#f2c96d'),('cooling','#72d6ed'),('data','var(--diagram-accent)'),('feedback','#bda4f3')])
    nodes='';details=''
